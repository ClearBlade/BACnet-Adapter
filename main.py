...
print("BACnet-Adapter v%s" % ADAPTER_VERSION)
...
# This code is no longer needed. Bacpypes was updated so that 
# the services supported are automatically set using introspection.
